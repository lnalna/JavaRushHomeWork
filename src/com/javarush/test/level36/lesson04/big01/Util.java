...
public final class Util {
    ...
    public static boolean isUserDeleted(JavaRushHomeWork.src.com.javarush.test.level36.lesson04.big01.bean.User user) {
        return user.getName().endsWith(DELETED_MARKER);
    }

    public static void markDeleted(JavaRushHomeWork.src.com.javarush.test.level36.lesson04.big01.bean.User user) {
