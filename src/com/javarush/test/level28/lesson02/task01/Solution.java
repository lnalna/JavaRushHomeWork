...
public class Solution {
    ...
    public static void switchTest(Enum obj) {
        //add your code here
       String temp= String.valueOf(obj.getClass());
       String result = temp.substring(temp.length()-2);

        switch(result)
        {
            case "E1": System.out.println("it's "+result+"."+obj); break;
            case "E2": System.out.println("it's "+result+"."+obj);break;
