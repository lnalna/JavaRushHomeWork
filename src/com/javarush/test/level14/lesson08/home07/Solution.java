...
public class Solution
{
    ...
    public static void cleanAllApartaments(List<Apartament> apartaments)
    {
        ...
        for (Apartament temp_app: apartaments)
        {
            if (temp_app instanceof Apt1Room) ((Apt1Room) temp_app).clean1Room();
            if (temp_app instanceof Apt2Room) ((Apt2Room) temp_app).clean2Rooms();
            if (temp_app instanceof Apt3Room) ((Apt3Room) temp_app).clean3Rooms();
        }
    }
