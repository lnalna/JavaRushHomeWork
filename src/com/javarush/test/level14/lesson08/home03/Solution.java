...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        while(true)
        {
          ...
          //  if (key.equals("looser")) list.add(key);
        ...
        {
             if (temp_str.equals("user")) { person = new Person.User(); doWork(person);}
             if (temp_str.equals("looser")) { person = new Person.Looser(); doWork(person);}
             if (temp_str.equals("coder"))  { person = new Person.Coder(); doWork(person);}
             if (temp_str.equals("proger")) { person = new Person.Proger(); doWork(person);}
        }
