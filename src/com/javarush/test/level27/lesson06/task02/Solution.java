...
public class Solution {
    ...
    public static boolean isNormalLockOrder(final Solution solution, final Object o1, final Object o2) throws Exception {
        //do something here
        //Comparator<Object>compareByHashCode= new Comparator<Object>()
        //{
          //  @Override
        ...
        return o1.hashCode()>o2.hashCode()? true: false;
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        new Thread() {
            ...
            public void run() {
                try {
                  System.out.println("o1 and o2 - "+isNormalLockOrder(solution, o1, o2)); //expected boolean b
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    System.out.println("o2 and o1 - "+isNormalLockOrder(solution, o2, o1)); //expected boolean !b
                } catch (Exception ignored) {
                }
            }
        }.start();
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    System.out.println("o1 and o1 - "+isNormalLockOrder(solution, o1, o1)); //expected boolean !b
                } catch (Exception ignored) {
                }
            }
        }.start();
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    System.out.println("o2 and o2 - "+isNormalLockOrder(solution, o2, o2)); //expected boolean !b
                } catch (Exception ignored) {
                }
            }
        }.start();
